...
<body>
  ...
  <div class="container">
    <h2><center ><font color=#b33939>DATA PESERTA</font></center></h2>
 ...
 ?>
    <tr>
      ...
      <td>
      <a class="edit" href="edit.php?id=<?php echo $baris_data['id']; ?>"><font color=#002C51>EDIT |</font></a> 
      <a class="hapus" href="delete.php?id=<?php echo $baris_data['id']; ?>"><font color=#002C51> DELETE</font></a>
      </td>
    </tr>
<?php } ?>
</body>
